...
<table class="tableData">
    <thead>
        ...
        @csrf
        <tr>
            <th colspan="7" style="text-align:right;background:#c6c2eb;">Filtrar: <input type="text" id="filtro" name="filtro" size="15" class="campo" style="font-weight:bold;width:150px;"/></th>
        </tr>
        </form>
        <tr>
